...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { token, userId, name, email: resEmail, role } = res.data;
      const user = { id: userId, name, email: resEmail, role };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-bg-base px-4 relative overflow-hidden animate-fade-in">
      ...
      <div className="absolute top-1/4 right-1/4 w-64 h-64 rounded-full bg-copper-400/3 blur-[80px] pointer-events-none" />
      ...
      <div className="relative w-full max-w-md animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <p className="font-body text-text-secondary mt-1 text-sm">Sign in to your account</p>
        </div>
        ...
        <div className="card-copper p-8 border-t-2 border-copper-500 animate-slide-up stagger-1">
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center text-xs font-body font-medium">
              <span className="px-3 bg-bg-surface text-text-dim">or continue with email</span>
            </div>
          </div>

          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block font-body font-semibold text-xs text-text-secondary uppercase tracking-wider mb-1.5">Email</label>
              <div className="relative">
                ...
                <input
                  ...
                  className={`input-copper !pl-10 ${fieldErrors.email ? 'border-red-500' : ''}`}
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="block font-body font-semibold text-xs text-text-secondary uppercase tracking-wider">Password</label>
                <Link to="/forgot-password" className="font-body text-xs text-copper-500 hover:text-copper-400 transition-colors font-medium">
                  Forgot?
                </Link>
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  className={`input-copper !pl-10 !pr-12 ${fieldErrors.password ? 'border-red-500' : ''}`}
            ...
            <button
              type="submit"
              disabled={loading}
              className="btn-copper w-full !py-3 !text-sm"
            >
              {loading ? (
        ...
        <p className="text-center mt-6 text-sm font-body text-text-secondary animate-slide-up stagger-2">
          ...
          <Link to="/register" className="text-copper-500 font-semibold hover:text-copper-400 transition-colors">
            Sign up
          </Link>
        </p>
      </div>
